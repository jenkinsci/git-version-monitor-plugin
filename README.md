...
[![Coverage](https://ci.jenkins.io/job/Plugins/job/git-version-monitor-plugin/job/main/badge/icon?status=${instructionCoverage}&subject=coverage&color=${colorInstructionCoverage})](https://ci.jenkins.io/job/Plugins/job/git-version-monitor-plugin/job/main)
